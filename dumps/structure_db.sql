...
CREATE TABLE `addresses` (
  ...
  `createdAt` datetime NOT NULL DEFAULT '2024-05-06 10:10:33',
  `updatedAt` datetime NOT NULL DEFAULT '2024-05-06 10:10:33',
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(255) DEFAULT 'default-img.jpg',
...
-- Dump completed on 2024-05-06  7:16:54
